...
Facet Maps are amazingly effective at showing change.  Perhaps this is actually better than animating.  It's certainly far less work using the `facet_wrap()` function.
...
!["Buttons instead of Slider"](images/dashboard--buttons.png "Dashboard with Buttons" )